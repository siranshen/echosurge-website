...
const floatingPlatforms = [
  { name: 'ChatGPT', logo: '/chatgpt-logo.svg', change: '+201%', changeColor: 'text-blue-500', positionClasses: 'top-[32%] -left-8 md:-left-16' },
  { name: 'DeepSeek', logo: '/deepseek-logo.svg', change: '+102%', changeColor: 'text-pink-500', positionClasses: 'bottom-[18%] -right-8 md:-right-16' },
]
            ...
            >
                ...
                <div className="flex flex-col gap-[10px] self-stretch">
                    {platforms.map((platform) => (
                        <div key={platform.name} className="bg-white rounded-md flex items-center justify-between p-[10px] text-base md:text-lg lg:text-xl">
