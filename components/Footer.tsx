...
export function Footer() {
  ...
  return (
    <footer className="mt-20 flex flex-col items-center justify-center" style={{
      background: 'linear-gradient(180deg, #F2FBFF 0%, rgba(242, 251, 255, 0.00) 40%)'
    }}>
      <div className="max-w-[1200px] w-full flex flex-col gap-10 lg:gap-12 items-start justify-center p-10 lg:p-12">
